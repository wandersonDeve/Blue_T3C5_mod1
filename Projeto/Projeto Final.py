...
#   CLASSE QUE MOSTRA O QUE TEM EM CASA
class Casa:
    def __init__(self):
        self.remedios = 1
        self.comida = 5
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("--"*20)
        print("Você tem que sair pro trabalho até às 07:00.")
        print(personagem)
        print("--"*20)
        print("Ações:")
        opcao = input("1 - Tomar banho e escovar os dentes\n2 - Fazer café da manhã\n3 - Pedir café da manhã\n4 - Tomar café da manhã\n5 - Tomar remédio\n6 - Comprar remédio\n7 - Ir trabalhar\n0 - Sair do jogo\nEscolha sua ação:")
        if opcao == "1":
